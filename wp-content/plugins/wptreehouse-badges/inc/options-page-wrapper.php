			...
			<div id="post-body-content">
				...
				<div class="meta-box-sortables ui-sortable">
										...
										<?php if( $wptreehouse_profile-> {'badges'}[$i]->{'url'} != $wptreehouse_profile->{'profile_url'} ): ?>									
											...
											<li class="wptreehouse-project-name">
												<a href="<?php echo $wptreehouse_profile->{'badges'}[$i]->{'courses'}[1]->{'url'}; ?>">
													<?php echo $wptreehouse_profile->{'badges'}[$i]->{'courses'}[1]->{'title'}; ?></a>
											</li>
					...
					<div class="postbox">
						...
						<p>
							<?php echo $wptreehouse_profile->{'badges'}[1]->{'courses'}[0]->{'title'}; ?>
						</p>
							<pre><code>
			...
			<div id="postbox-container-1" class="postbox-container">
				...
				<div class="meta-box-sortables">
					...
					<div class="postbox">
						...
						<h3><span><?php echo $wptreehouse_profile->{'name'} ?> Profile</span></h3>
						<div class="inside">
